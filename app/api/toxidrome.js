...
router.post('/compare', function(req, res, next) {
    ...
    let myPromise = new Promise((resolve, reject) => {
        ...
        Case.find({
            ...
            for (var i = 0; i < cas.length; i++) { // boucle sur les condidats potentiels
                ...
                console.log(child_id + " : " + cas[i].child);
                ...
                Hemodynamic.find({
                    ...
                    Pleuro.find({
                        ...
                        Child.find({
                            ...
                            console.log("distance count: " + distanceEuclidienne(age1, age2));
                            count++
                            ...
                            Case.find({
                                ...
                                console.log('disimilarite : ' + disimilarite);
                                console.log('similarite : ' + similarite);
    ...
    myPromise.then((sim) => {
        console.log("Sim count: " + sim.length);
